...
if __name__ == "__main__":
    ...
    IMAGE_FOLDER = "/home/nakshtra/Desktop/GroundingDINO/apexdata"
    OUTPUT_DIR = "/home/nakshtra/Desktop/GroundingDINO/output"
    #assignment data setTEXT_PROMPT = "small brown miniature car. white plane. white inverted umbrella. brown suitcase luggage bag. black mattress. red mattress. blue badminton racket. orange cricket bat. blue umbrella.basketball.black tennis racket cover"
    #apex snowboard data
    ...
    #TEXT_PROMPT = "people.brown lugguage bag. blue plane.orange basket ball.red mattress"
    #TEXT_PROMPT = "white plane. brown lugguage bag"
    # Thresholds
    #pehle 0.36 tha
    BOX_THRESHOLD = 0.40
    TEXT_THRESHOLD = 0.35
